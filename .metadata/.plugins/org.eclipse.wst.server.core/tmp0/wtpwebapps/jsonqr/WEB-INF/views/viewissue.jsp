...
Dippocode : ${south.thisolcode}</textarea>
							...
							<div >
								...
								<div >
									<a  href="download?isuno=${south.isuno}&olcode=${south.thisolcode}" id="" title="varify">Download JSON</a> <a  href="download json file to upload GST e-invoice portal"
										title="Save changes"></a>
								</div>
