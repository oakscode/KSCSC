...
<body>
	...
	<div class="container-fluid">
		<div class="container">
			<h2 class="text-center" id="title">E-invoice QR Code Generator</h2>
			<p class="text-center">
							...
							<fieldset>
								...
								<table>
									<tr>
										...
										<td>E-Invoice json</td>
										<td><input type="file" id="myfile" name="filejson"></td>
										</div>
									</tr>
									<tr>
										<div class="form-group">
										<td>Invoice</td>
										<td><input type="file" id="myfile" name="fileinvoice"></td>
										</div>
									</tr>
								</table>
